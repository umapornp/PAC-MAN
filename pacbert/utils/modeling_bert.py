...
class BertLayer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, output_attentions):
        ...
        layer_output = self.output(intermediate_output, attention_outputs[0])
...
class BertEncoder(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, output_hidden_states, output_attentions):
        ...
        return outputs # (outputs, (all_hidden_states), (all_attentions))
